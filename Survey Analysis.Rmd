...
## American Nyckelharpa Association Annual Survey

Hi if you participated in this survey, you will be interested to see some results! The member survey had `r member_responses` respondents and the general one had `r general_responses`, for a total of `r member_responses + general_responses` responses. We are excited to share with you some interesting insights!
...
```
<br>
^ Preliminary, will make this better soon
